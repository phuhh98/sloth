...
- milestone_updated_at: 2026-05-10T23:10:00Z
...
- [x] CLI-001: Set up CLI package structure (Go + Cobra scaffold)
...
- [x] CLI-002: Implement config.yaml parser for host profiles
...
- [x] CLI-003: Create lock.json format and file I/O operations
...
- [x] CLI-004: Implement local .sloth/ workspace initialization
...
- [x] CLI-005: Implement sloth contracts list with plugin version flag
...
- [x] CLI-006: Implement sloth contracts inspect host command
...
- [x] CLI-007: Add output formatting for list and inspect
...
- [x] CLI-008: Implement sloth contracts add component
...
- [x] CLI-009: Implement sloth contracts add set
...
- [x] CLI-010: Implement sloth contracts add --all
...
- [x] CLI-011: Build schema version compatibility checking logic
...
- [x] CLI-012: Implement name collision detection in verification
...
- [x] CLI-013: Implement sloth contracts verify --file
...
- [x] CLI-014: Implement sloth contracts push with drift and retry
...
- [x] CLI-015: Write integration tests and document CLI contract
...
- [x] CLI-016: Add cross-platform Go build and checksum pipeline
...
- [x] CLI-017: Create npm wrapper package for binary distribution
...
- [x] CLI-018: Validate npm install flow and release contract
...
- [x] CLI-019: Add Taskfile commands for CLI distribution workflow
...
- [x] CLI-020: Implement config-driven npm publish package generation
...
- [ ] None
  - what: no active task
  - do: milestone execution complete
  - next: archive board
  - deps: none
  - status: in-progress
...
- [x] CLI milestone completed
  - what: all CLI-001..CLI-020 tickets completed and validated
  - do: archive this board and transition to next milestone board
  - next: begin Milestone 3 planning
  - deps: none
  - status: done
...
- Next:
  - Milestone 2 complete. Move board to docs/archive/ and start Milestone 3 board when ready.
